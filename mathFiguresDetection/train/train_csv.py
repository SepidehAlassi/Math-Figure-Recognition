...
if __name__ == '__main__':
    ...
    model.fit_generator(
        ...
        callbacks=[
            keras.callbacks.ModelCheckpoint(os.path.join('snapshots', 'resnet50_csv_16_04.h5'), monitor='val_loss', verbose=1, save_best_only=True),
    ...
    model.save(os.path.join('snapshots', 'resnet50_csv_16_04.h5'))
